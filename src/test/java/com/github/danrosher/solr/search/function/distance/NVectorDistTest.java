...
public class NVectorDistTest extends SolrTestCaseJ4 {
    ...
    public void testNVector() throws Exception {
        ...
        assertU(commit());
        assertJQ(req("defType", "lucene", "q", "*:*", "fl", "*"),
            "/response/docs/[0]== {" +
                "'id':'0'," +
                "'nvector_0_d':0.6152990562577377," +
                "'nvector_1_d':-0.005263047078845837," +
                "'nvector_2_d':0.7882762026750415," +
                "'nvector':'52.02471051274793, -0.49007556238612354'}");

        assertJQ(req(
            "defType", "lucene",
            "q", "*:*",
            "fl", "*,dist:nvdist(52.01966071979866, -0.4983083573742952,nvector)"),
